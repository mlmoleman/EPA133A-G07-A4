...
#     flood_par = [False]
# else:
#     flood_par = [True,False]
params = {"collapse_dict": [prob], "routing_type": "shortest","flood_lever":False}
# print(params)
...
df_results.to_csv("../experiment/Scenario" + str(scenario) + "FALSE.csv")
